...
\newthought{Tensor Unit:} The one-point space $\{\star\}$ with topology $\{\varnothing,\{\star\}\}$.
...
\newthought{Tensor Product:} For objects, the topological product. For morphisms, the product of relations. 
