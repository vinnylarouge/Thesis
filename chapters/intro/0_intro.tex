...
\[ [\![ \texttt{that} ]\!] := \lambda \ \texttt{N}_1 \ \texttt{N}_2 \ \texttt{N}_3 \ \texttt{N}_4 \ \texttt{TV} \ \texttt{DV} \ \ . \ \ \texttt{TV}(\texttt{N}_1,\texttt{N}_2) \wedge \texttt{DV}(\texttt{N}_3,\texttt{N}_4,\texttt{N}_2) \]
