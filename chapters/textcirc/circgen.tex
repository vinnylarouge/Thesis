...
\begin{myboxB}
\begin{rules}[Complex sentences]\label{fig:sentbestiary}
...
\begin{myboxB}
\begin{rules}[Coreferential structure and noun labels]
...
\[
\resizebox{\textwidth}{!}{\tikzfig{mushroom/simpleCFG}}
\]
...
\[
\resizebox{0.5\textwidth}{!}{\tikzfig{mushroom/simpcorr}}
\]
\end{proof}
\end{proposition}
...
\caption{
\begin{example}[\textbf{Passive voice}]
...
\caption{
\begin{example}[\textbf{Possessive pronouns}]
...
\subsection{Extensions III: Types and Nesting}
...
\caption{
\begin{example}[\textbf{Intensifers}]
...
\caption{
\begin{example}[\textbf{Comparatives}]
