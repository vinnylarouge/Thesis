...
\newthought{Passive voice}

\begin{example}[\texttt{School bores Bob} = \texttt{Bob \underline{is bored by} school}]

\end{example}

\newthought{Copulas, and attributive vs. predicative modifiers}
...
\subsection{Extensions IV: syncategorematicity and structural logic}
...
\subsection{Extensions V: determiners, quantifiers, context}
