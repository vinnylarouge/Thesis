...
While it would work, it would be explanatorily void to say that any modern programming language is a model for text circuits. Since semanticists like to work with sets, I provide the following construction.
