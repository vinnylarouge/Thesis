...
\newthought{Now we define a very useful structure.} Spiders -- or special frobenius algebras (introduced in \citep{paquette_categorical_2008}) -- will be important throughout this thesis.
...
\begin{myboxB}
\begin{term}
A \emph{hypergraph category} \citep{fong_hypergraph_2018} is a symmetric monoidal category in which every object is equipped with a choice of spider, and spiders of tensors are tensors of spiders, as illustrated below:
